...
with atakofthecerts.AtakOfTheCerts() as aotc:
    aotc.generate_ca(expiry_time_days=3650)
    aotc.bake(common_name="192.168.1.100", cert="server", expiry_time_days=3650)
    aotc.bake(common_name="user", cert="user", expiry_time_days=3650)
...
if __name__ == '__main__':
    print("Do not run this file, it just contains examples")
